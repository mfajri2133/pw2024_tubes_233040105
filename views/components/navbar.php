     ...
     <div>
          <div class="flex items-center justify-between ">
               <div class="flex items-center justify-start rtl:justify-end px-3 py-3 lg:px-5 lg:pl-3">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg xl:hidden lg:hidden md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
               ...
               <div class="flex items-center">
                    <button type="button" class="flex text-sm " data-dropdown-offset-skidding="100" data-dropdown-placement="left" aria-expanded="false" data-dropdown-toggle="dropdown-user">
