<nav class="bg-[#181a1b] dark:bg-gray-900 sticky w-full z-20 top-0 start-0 border-b !border-[#fff] dark:border-gray-600 shadow">
     <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex md:order-2 xl:order-2 lg:order-2 space-x-3 md:xl:lg:space-x-0 rtl:space-x-reverse">
               <?php if (login_check()) : ?>
               ...
               <?php endif; ?>
               <button data-collapse-toggle="navbar-sticky" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden lg:hidden xl:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false">
          ...
          <div class="items-center justify-between hidden sm:w-full lg:flex lg:w-auto lg:order-1 xl:flex xl:w-auto xl:order-1 md:flex md:w-auto md:order-1 " id="navbar-sticky">
               <ul class="flex sm:flex-col sm:p-4 py-0 gap-2 sm:mt-4 justify-center lg:items-center content-center font-medium sm:border border-[#fff]  rounded-lg bg-[#181a1b]  rtl:space-x-reverse flex-row mt-0 border-0 ">
                    <li>
                         <form id="search-form" class="max-w-lg sm:max-w-md m-0">
                              <label for="movie-search" class="text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
                              <div class="relative">
                                   ...
                                   <input id="movie-search" class="block w-full px-4 py-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Movie" />
                    ...
                    <li class="order-first">
                         <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class=" sm:justify-between w-full  text-white font-medium bg-[#007bff] rounded-lg px-4 py-[0.45rem] flex items-center justify-center">
                              <span>Menu</span>
