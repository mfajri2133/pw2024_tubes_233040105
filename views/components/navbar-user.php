...
<nav class="bg-[#181a1b] dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b !border-[#fff] dark:border-gray-600 shadow">
     <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
               ...
               <?php else : ?>
                    <a href="<?= base_url("/views/login.php") ?>" class="text-white bg-[#007bff] hover:bg-[#fff] hover:text-[#007bff] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center ">Sign In</a>
               <?php endif; ?>
          ...
          <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 poppins" id="navbar-sticky">
               <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-[#fff] rounded-lg bg-[#181a1b] md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                         <a href="<?= base_url('/views/index.php') ?>" class="block py-2 px-3 text-[#fff] rounded md:p-0 hover:text-[#007bff] <?php echo $current_page == 'index' ? 'text-[#007bff]' : ''; ?>">Home</a>
                    </li>
                    <li>
                         <a href="<?= base_url('/views/about.php') ?>" class="block py-2 px-3 text-[#fff] rounded md:p-0 hover:text-[#007bff] <?php echo $current_page == 'about' ? 'text-[#007bff]' : ''; ?>">About</a>
                    </li>
                    <li>
                         <a href="<?= base_url('/views/services.php') ?>" class="block py-2 px-3 text-[#fff] rounded md:p-0 hover:text-[#007bff] <?php echo $current_page == 'services' ? 'text-[#007bff]' : ''; ?>">Services</a>
                    </li>
                    <li>
                         <a href="<?= base_url('/views/contact.php') ?>" class="block py-2 px-3 text-[#fff] rounded md:p-0 hover:text-[#007bff] <?php echo $current_page == 'contact' ? 'text-[#007bff]' : ''; ?>">Contact</a>
                    </li>
               </ul>
          </div>
     </div>
