                    ...
                    <div class="p-5 sm:p-0">
                         ...
                         <form action=<?= base_url("/controller/profile.php?action=update") ?> method="POST" enctype="multipart/form-data">
                              ...
                              <div class="mb-4">
                                   ...
                                   <input id="img_profile_path" name="img_profile_path" type="file" accept=".jpg, .jpeg, .png" class="block w-full file:!text-xs file:!bg-blue-400 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 " aria-describedby="file_input_help">
