...
<section class="bg-[#181a1b]  py-8 px-44 md:px-7 sm:px-8 min-h-full w-full">
     <div class="border border-gray-500 rounded-md mb-8 ">
          <div class="grid grid-cols-2 sm:grid-cols-1 p-6">
               <div class="sm:mb-4 text-white">
                    <div class="font-semibold text-lg">Personal Information</div>
                    <p class="text-sm">Update your personal detail here</p>
               </div>

               <div class="border border-gray-500 rounded-md sm:border-none sm:rounded-none">
                    <div class="p-5 sm:p-0">
                         ...
                         <form action=<?= base_url("/controller/profile.php?action=update") ?> method="POST" enctype="multipart/form-data">
                              <div class="mb-4">
                                   ...
                                   <input type="username" id="username" name="username" required value="<?= $_SESSION['user']['username'] ?>" class="block w-full p-2  border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 text-gray-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  ">
                              </div>
                              <div class="mb-4">
                                   <label for="name" class="block mb-2 text-sm font-medium text-white dark:text-white">Nama</label>
                                   <input type="text" id="name" name="name" required value="<?= $_SESSION['user']['name'] ?>" class="block w-full p-2  border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  text-gray-500 ">
                              </div>
                              <div class="mb-4">
                                   <label for="img_profile_path" class="block mb-2 text-sm font-medium text-white dark:text-white">Profile Image</label>
                                   <input id="img_profile_path" name="img_profile_path" type="file" accept=".jpg, .jpeg, .png" class="block w-full file:!text-xs file:!bg-blue-400 text-xs text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 " aria-describedby="file_input_help">
               ...
               <div class="border border-gray-500 rounded-md sm:border-none sm:rounded-none">
                    <div class="p-5 sm:p-0">
                         <form id="change-password-form" action=<?= base_url("/controller/profile.php?action=change_password") ?> method="POST" onsubmit="return validateFormPassword()">
                              <div class="mb-4">
                                   <label for="password" class="block mb-2 text-sm font-medium text-white dark:text-white">Current Password</label>
                                   <div class="relative w-full">
                                        <input type="password" id="password" name="password" required class="js-password block w-full p-2  border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 text-gray-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  text-gray-500 ">
                              ...
                              <div class="mb-4">
                                   <label for="new_password" class="block mb-2 text-sm font-medium text-white dark:text-white">New Password</label>
                                   <div class="relative w-full">
                                        <input type="password" id="new_password" name="new_password" required class="js-new-password block w-full p-2  border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 text-gray-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  text-gray-500 ">
                                        <div class="absolute inset-y-0 right-0 flex items-center px-2">
                              ...
                              <div class="mb-4">
                                   ...
                                   <div class="relative w-full">
                                        <input type="password" id="confirm_password" name="confirm_password" required class="js-confirm-password block w-full p-2  border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 text-gray-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  text-gray-500 ">
                                        <div class="absolute inset-y-0 right-0 flex items-center px-2">
