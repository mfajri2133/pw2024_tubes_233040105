                              ...
                              <div id="deleteModal<?= $category['id'] ?>" tabindex="-1" class="fixed inset-0 z-50 hidden flex items-center justify-center w-full p-4 overflow-x-hidden overflow-y-auto">
                                   <div class="relative w-full max-w-md max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                             ...
                                             <!-- Modal body -->
                                             <form action="../controller/category.php?action=delete" method="POST" class="m-0">
                         ...
                         response.forEach(function(user) {
                              ...
                              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                   ...
                                   <td class="px-4 py-4 text-center w-24">
                                        ...
                                        `<button type="button" data-modal-target="deleteModal${user.id}" data-modal-show="deleteModal${user.id}" class="bg-gray-300 px-2 py-2.5 mx-1.5 text-xs rounded-full text-gray-500 hidden">
                                             <i class="fa-solid fa-user-slash"></i>
                                        </button>` : 
                                        `<button type="button" data-modal-target="deleteModal${user.id}" data-modal-show="deleteModal${user.id}" class="delete-button bg-red-600 px-2 py-2.5 mx-1.5 text-xs  rounded-full text-white">
                                             <i class="fa-solid fa-user-slash"></i>
                                        </button>`}
                                   </td>
                              </tr>
                    <div id="deleteAdminModal${user.id}" tabindex="-1" class="fixed inset-0 z-50 hidden flex items-center justify-center w-full p-4 overflow-x-hidden overflow-y-auto">
                         <div class="relative w-full max-w-md max-h-full">
                              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                   ...
                                   <form action="../controller/delete_admin.php" method="POST" class="m-0">
